...
@ zoogie magic away!!!!!!!!!!!!!!!!!!
@ with some edits for a new pivot
#ifndef ROP_POPR3_ADDSPR3_POPPC
	.macro ROPMACRO_STACKPIVOT_PREPARE
	...
	.word POP_R0PC
		.word ROPBUFLOC(. + 0x4) // guess can say, expects ROPMACRO_STACKPIVOT_PREPAREREGS_BEFOREJUMP right after
	.endm
	
	.macro ROPMACRO_STACKPIVOT_PREPAREREGS_BEFOREJUMP r12, sp, lr, pc
		.word \r12
		.word \sp
		.word \lr
		.word \pc
	...
	.macro ROPMACRO_SELFVTABLE_STACKPIVOT_PREPAREREGS_BEFOREJUMP vtable_call_offset, sp, pc
	ROPMACRO_STACKPIVOT_PREPAREREGS_BEFOREJUMP (ROPBUFLOC(.) - \vtable_call_offset + 0x8), \sp, STACK_PIVOT, \pc
	.endm

	.macro ROPMACRO_STACKPIVOT_PREPAREREGS_BEFOREJUMP_DEFAULT sp, pc
	ROPMACRO_STACKPIVOT_PREPAREREGS_BEFOREJUMP STACK_PIVOT, \sp, GARBAGE, \pc
	.endm
#endif
...
#ifndef ROP_POPR3_ADDSPR3_POPPC
ROPMACRO_STACKPIVOT_PREPARE

ROPMACRO_STACKPIVOT_PREPAREREGS_BEFOREJUMP_DEFAULT \sp, \pc
...
#define ROPMACRO_CMPDATA_CMPWORD_OFFSET 0x38
	...
	#ifndef ROP_POPR3_ADDSPR3_POPPC
	ROP_SETR0 ROPBUFLOC(. + 0x8 - 0x4 + 0x4) @ 8 size of ROP_SETR0, - 4 offset actual usage in inside ROP_SETR0, + 4 skip POP_R4R8PC
	.word POP_R4R7PC @ skip ahead pivot data

	@ pivot data for the vtable call
	@ROPMACRO_STACKPIVOT_PREPAREREGS_BEFOREJUMP ropkit_cmpobject_vtable, \stackaddr_cmpmismatch, ROP_POPPC
	ROPMACRO_SELFVTABLE_STACKPIVOT_PREPAREREGS_BEFOREJUMP 0x30, \stackaddr_cmpmismatch, ROP_POPPC
